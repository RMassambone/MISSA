...
int main( int argc, char **argv )
{
   ...
   std::vector< std::vector< double > > P(7, std::vector< double >( 7, 1.0 / 7.0 ));
   std::vector< std::vector< double > > init_distributions(nchains, std::vector< double >( 7, 1.0 / 7.0 ));
   ...
   // Incremental stoc. randomized sub. object.
   MISSA randomized_op(x.size(), nchains, nthreads, mode);
   ...
   for ( int test = 1; test < 2; test++ ){
	   ...
	   for ( int k = 0; k < niters; k++ ){
	      ...
	      // Optimization step
	      randomized_op.apply( lambda, next_states, eps, x );
	  ...
	  /*
	  char buffer [500];
	  int str = std::sprintf(buffer, "/home/rmassambone/Documentos/Elias-Eduardo/MISSA-testes/results/diminishing-stepsize/longer_horizon/time_randomized_test-%d.txt", test );
	  FILE * arq;
	  ...
	  */
	  ...
	  char buffer [500];
	  int str = std::sprintf(buffer, "/home/rmassambone/Documentos/Elias-Eduardo/MISSA-testes/results/constant-stepsize/best-for-each/objective_randomized_test-%d.txt", test );
	  FILE * arq;
	  arq = std::fopen (buffer , "w" );
	  ...
	  /*
	  char buffer3 [500];
	  int str3 = std::sprintf(buffer3, "/home/rmassambone/Documentos/Elias-Eduardo/MISSA-testes/results/diminishing-stepsize/longer_horizon/time_best_randomized_test-%d.txt", test );
	  FILE * arq3;
	  ...
	  char buffer4 [500];
	  int str4 = std::sprintf(buffer4, "/home/rmassambone/Documentos/Elias-Eduardo/MISSA-testes/results/diminishing-stepsize/longer_horizon/objective_best_randomized_test-%d.txt", test );
	  FILE * arq4;
